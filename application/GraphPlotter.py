...
# Assuming your data array is called 'data' with shape (490, 18)
# Assuming your final clusters array is called 'final_clusters' with shape (490,)

indexToDimension = ['Voltage Magnitude at Node 1','Voltage Magnitude at Node 2','Voltage Magnitude at Node 1','Voltage Magnitude at Node 4','Voltage Magnitude at Node 5','Voltage Magnitude at Node 6','Voltage Magnitude at Node 7','Voltage Magnitude at Node 8','Voltage Magnitude at Node 9',
               'Voltage Angle at Node 1','Voltage Angle at Node 2','Voltage Angle at Node 3','Voltage Angle at Node 4','Voltage Angle at Node 5','Voltage Angle at Node 6','Voltage Angle at Node 7','Voltage Angle at Node 8','Voltage Angle at Node 9']


def scatterPlotScikitLearn(inputs, dimensions, final_cluster):
    ...
    for i in range(num_plots):
        ...
        ax.set_xlabel(f'{indexToDimension[random_dimensions[i, 0]]}')
        ax.set_ylabel(f'{indexToDimension[random_dimensions[i, 1]]}')
...
def scatterPlot(inputs, final_cluster):
    num_plots = 5
...
def barChartScikitLearn(final_cluster):
    static_folder = os.path.join("application", "static")
    os.makedirs(static_folder, exist_ok=True)    
...
def plot(inputs_df, final_cluster):
    ...
    filenamesScatterPlot, dimensions =  scatterPlot(inputs, final_cluster)
    filenameBarChart = barChart(final_cluster)
    filenamesScikitLearn, cluster_labels = scatterPlotScikitLearn(inputs, dimensions, final_cluster)
    filenameBarChartScikitLearn = barChartScikitLearn(cluster_labels)

    # Show the filenames
    return filenamesScatterPlot
